...
% Aqui introduzimos vetores binários para representar cada classe. Assim
% classes(i,1) representa o diagnóstico do paciente i, enquanto classes(i,2)
% representa sua codificação em vetor binário.

% Bom ver se dá pra usar o cellfun combinado com o de2bi
