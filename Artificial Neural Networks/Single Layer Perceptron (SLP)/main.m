...
for i = 1 : n_iter
    ...
    % Training network until ends the number of epochs in the outside loop
    % Training each sample from the training data to update the weight vector
    % iteratively in the inside loop
    for j = 1 : n_epochs
        for k = 1 : n_patterns
