function [data, classes] = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [VARNAME1,VARNAME2,VARNAME3,VARNAME4,VARNAME5,VARNAME6,DH] =
...
anguloDeIncidenciaPelvica = dataArray{:, 1};
anguloDeVersaoPelvica = dataArray{:, 2};
anguloDeLordose = dataArray{:, 3};
decliveSacral = dataArray{:, 4};
raioPelvico = dataArray{:, 5};
grauDeDeslizamento = dataArray{:, 6};
classes = dataArray{:, 7};

data = horzcat(anguloDeIncidenciaPelvica, anguloDeVersaoPelvica, ...
               anguloDeLordose, decliveSacral, raioPelvico, grauDeDeslizamento);
